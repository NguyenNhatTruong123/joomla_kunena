...
jQuery(document).ready(function ($) {
        ...
        (function init() {
            ...
            if ($('#krating').length > 0) {
                $.ajax({
                        ...
                        showRecentRating(buildItem(), response.data, topic_id, userid)
        ...
        function showRecentRating(ratingItem, rate, topicid, userid) {
            // debugger;
            ...
            const r = rating(ratingItem, rate, 5, userid, callback);
        }
        ...
        function buildItem() {
            ...
            // ratingItem.appendChild(content);
