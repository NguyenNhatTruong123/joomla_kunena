...
return [
    ...
    'checksum' => '50d4813e646e1b3d0bd6bfe6a5e7fbb9',
    'files' => [
        'templates/jl_zmagazine_free/particles' => [
            'particles/backtotop' => [
                'file' => 'templates/jl_zmagazine_free/particles/backtotop.yaml',
                'modified' => 1650510305
            ],
            'particles/contentcubes' => [
                'file' => 'templates/jl_zmagazine_free/particles/contentcubes.yaml',
                'modified' => 1650510305
            ],
            'particles/contenttabs' => [
                'file' => 'templates/jl_zmagazine_free/particles/contenttabs.yaml',
                'modified' => 1650510305
            ],
            'particles/copyright' => [
                'file' => 'templates/jl_zmagazine_free/particles/copyright.yaml',
                'modified' => 1650510305
            ],
            'particles/horizontalmenu' => [
                'file' => 'templates/jl_zmagazine_free/particles/horizontalmenu.yaml',
                'modified' => 1650510305
            ],
            'particles/owlcarousel' => [
                'file' => 'templates/jl_zmagazine_free/particles/owlcarousel.yaml',
                'modified' => 1650510305
            ],
            'particles/sample' => [
                'file' => 'templates/jl_zmagazine_free/particles/sample.yaml',
                'modified' => 1650510305
            ],
            'particles/sticky' => [
                'file' => 'templates/jl_zmagazine_free/particles/sticky.yaml',
                'modified' => 1650510305
            ]
        ],
        ...
        'templates/jl_zmagazine_free/blueprints' => [
            'page' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/page.yaml',
                'modified' => 1650510305
            ],
            'styles/accent' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/accent.yaml',
                'modified' => 1650510305
            ],
            'styles/base' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/base.yaml',
                'modified' => 1650510305
            ],
            'styles/bottom' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/bottom.yaml',
                'modified' => 1650510305
            ],
            'styles/breaking' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/breaking.yaml',
                'modified' => 1650510305
            ],
            'styles/breakpoints' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/breakpoints.yaml',
                'modified' => 1650510305
            ],
            'styles/feature' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/feature.yaml',
                'modified' => 1650510305
            ],
            'styles/footer' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/footer.yaml',
                'modified' => 1650510305
            ],
            'styles/header' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/header.yaml',
                'modified' => 1650510305
            ],
            'styles/main' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/main.yaml',
                'modified' => 1650510305
            ],
            'styles/menu' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/menu.yaml',
                'modified' => 1650510305
            ],
            'styles/navigation' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/navigation.yaml',
                'modified' => 1650510305
            ],
            'styles/offcanvas' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/offcanvas.yaml',
                'modified' => 1650510305
            ],
            'styles/showcase' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/showcase.yaml',
                'modified' => 1650510305
            ],
            'styles/subfeature' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/subfeature.yaml',
                'modified' => 1650510305
            ],
            'styles/top' => [
                'file' => 'templates/jl_zmagazine_free/blueprints/styles/top.yaml',
                'modified' => 1650510305
            ]
        ],
    ...
    'data' => [
        'items' => [
            ...
            'styles.breaking.background' => [
                'type' => 'input.colorpicker',
                'label' => 'Background',
                'default' => '#ffffff',
                'name' => 'styles.breaking.background'
            ],
            'styles.breaking.text-color' => [
                'type' => 'input.colorpicker',
                'label' => 'Text',
                'default' => '#3b5265',
                'name' => 'styles.breaking.text-color'
            ],
            'styles.breaking.overlay' => [
                'type' => 'input.colorpicker',
                'label' => 'Overlay',
                'description' => 'Set the color of the page overlay when the certain menu modes are active.',
                'default' => 'rgba(0, 0, 0, 0.4)',
                'name' => 'styles.breaking.overlay'
            ],
            'styles.breakpoints' => [
                'type' => '_root',
                'form_field' => false,
        ...
        'nested' => [
            ...
            'styles' => [
                ...
                'breaking' => [
                    'background' => 'styles.breaking.background',
                    'text-color' => 'styles.breaking.text-color',
                    'overlay' => 'styles.breaking.overlay'
                ],
                'breakpoints' => [
