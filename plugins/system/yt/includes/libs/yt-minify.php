...
class YT_Minify extends JObject
{
	...
	function setMinifyConfigFile()
	{
		...
		$content = file_get_contents(JPATH_PLUGINS.J_SEPARATOR."system".J_SEPARATOR."yt".J_SEPARATOR."includes".J_SEPARATOR."libs".J_SEPARATOR."minify".J_SEPARATOR."config_default.php");
		$content = explode("\n", $content);
