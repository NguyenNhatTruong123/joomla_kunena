...
<form action="<?php echo Route::_($this->query->toUri()); ?>" method="get" class="js-finder-searchform">
	...
	<fieldset class="com-finder__search word mb-3 jl-fieldset">
	...
	<?php if ($this->params->get('show_advanced', 1)) : ?>
		<fieldset id="advancedSearch" class="jl-fieldset com-finder__advanced js-finder-advanced collapse<?php if ($this->params->get('expand_advanced', 0)) echo ' show'; ?>">
