...
<?php if ($params->get('dropdown', 0)) : ?>
    <div class="jl-inline">
            ...
            <ul role="listbox" aria-labelledby="language_picker_des_<?php echo $module->id; ?>" class="jl-nav jl-dropdown-nav">
...
<?php else : ?>
	<ul role="listbox" aria-labelledby="language_picker_des_<?php echo $module->id; ?>" class="<?php echo $params->get('inline', 1) ? 'jl-subnav' : 'jl-nav jl-nav-default'; ?>">
