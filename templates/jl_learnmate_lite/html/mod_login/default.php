...
<form action="<?= Route::_('index.php', true, $params->get('usesecure')) ?>" method="post">
    ...
    <div class="jl-margin">
        <input class="jl-input" type="text" name="username" size="18" placeholder="<?= Text::_('MOD_LOGIN_VALUE_USERNAME') ?>">
    </div>

    <div class="jl-margin">
        <input class="jl-input" type="password" name="password" size="18" placeholder="<?= Text::_('JGLOBAL_PASSWORD') ?>">
    </div>

    <?php if (count($twofactormethods) > 1) : ?>
    <div class="jl-margin">
        <input class="jl-input" type="text" name="secretkey" tabindex="0" size="18" placeholder="<?= Text::_('JGLOBAL_SECRETKEY') ?>">
    </div>
    <?php endif ?>
    ...
    <div class="jl-margin">
        <button class="jl-button jl-button-primary" value="<?= Text::_('JLOGIN') ?>" name="Submit" type="submit"><?= Text::_('JLOGIN') ?></button>
    </div>
