...
<div class="item-first item-wrap">
	...
	<?php } 
	if((int)$params->get('item_desc_display',1) && MegaNewsHelper::_trimEncode($item0->introtext) !=''){?>
	...
	<ul class="other-links">
		...
		<li>
			...
			<?php if((int)$params->get('item_desc_display',1)){?>
				<p class="item-desc"><?php echo MegaNewsBaseHelper::truncate(strip_tags($item->introtext), $params->get('item_desc_max_characs',200)); ?></p>
			<?php } ?>
		</li>
		<?php } ?>
	</ul>
