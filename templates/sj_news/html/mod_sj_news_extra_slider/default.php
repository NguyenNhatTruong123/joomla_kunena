...
if (!empty($list)) {
    ...
    ContentExtrasliderImageHelper::setDefault($params);
    ...
    <div id="<?php echo $tag_id; ?>" class="sj-extraslider <?php if ($options->effect == 'slide') { echo $options->effect; } ?> <?php echo $class_respl; ?> <?php echo $btn_type; ?>"><!--<![endif]-->
		...
		<div class="extraslider-top">
            <div class="heading-title google-font"><?php echo $options->title_slider; ?></div><!--end heading-title-->
        </div>    
			<?php
        }
        ?>
								...
								<div class="item-info">
									...
									<?php } ?>
										...
										<div class="item-content">
											<?php if ($options->item_desc_display == 1 && !empty($item->introtext)) { ?>
											<?php if ($options->item_desc_display == 1 && $item->introtext != '') { ?>
												<div class="item-description">
													<?php echo ContentExtrasliderHelper::truncate($item->introtext, $options->item_desc_max_characs); ?>
												</div>
											<?php } ?>
											<?php } ?>
											<?php $tags = '';
