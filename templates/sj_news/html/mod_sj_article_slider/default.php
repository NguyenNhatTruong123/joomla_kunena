...
ArticlesSliderImageHelper::setDefault($params);
									...
									<?php if( $options->item_title_display == 1 ){?>
										<div class="item-title  google-font">
											<a href="<?php echo $item->link;?>" title="<?php echo $item->title; ?>"  <?php echo  ArticlesSliderHelper::parseTarget($options->item_link_target);?>>
												<?php echo str_replace("...","",ArticlesSliderHelper::truncate($item->title, $params->get('item_title_max_characs',20)));?>
											</a>
										</div>
									<?php }?>
										...
										<?php if( $options->show_introtext == 1 ){?>
											<div class="item-des">
												...
												<?php echo ArticlesSliderHelper::truncate($item->introtext, $params->get('introtext_limit',200)); ?>
											</div>
										<?php }?>
