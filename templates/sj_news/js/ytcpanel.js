...
jQuery(document).ready(function() {
	jQuery('.ytitem_1').on('click', function() {
	  jQuery('#ytitem_1').slideToggle();
	  jQuery('.collapse').not(jQuery('#ytitem_1')).slideUp();
	});
	jQuery('.ytitem_2').on('click', function() {
	  jQuery('#ytitem_2').slideToggle();  
	  jQuery('.collapse').not(jQuery('#ytitem_2')).slideUp();
	});	
	jQuery('.ytitem_3').on('click', function() {
	  jQuery('#ytitem_3').slideToggle();  
	  jQuery('.collapse').not(jQuery('#ytitem_3')).slideUp();
	});	
	jQuery('.ytitem_4').on('click', function() {
	  jQuery('#ytitem_4').slideToggle();  
	  jQuery('.collapse').not(jQuery('#ytitem_4')).slideUp();
	});	
});
